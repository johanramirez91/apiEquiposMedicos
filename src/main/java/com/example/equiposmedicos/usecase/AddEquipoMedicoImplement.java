...
@Service
@Validated
public class AddEquipoMedicoImplement implements  AddEquipoMedico{

    private final RepositorioEquipoMedico repositorioEquipoMedico;
    private final EquipoMedicoMapper mapper;

    @Autowired
    public AddEquipoMedicoImplement(RepositorioEquipoMedico repositorioEquipoMedico, EquipoMedicoMapper mapper) {
    ...
    public Mono<EquipoMedicoDTO> apply(EquipoMedicoDTO equipoMedicoDTO) {
        return repositorioEquipoMedico
                .save(mapper.mapperToEquipoMedico().apply(equipoMedicoDTO))
